...
var tooltipStyles = __assign(__assign({}, defaultStyles), {
...
var getStockValue = function (d) {
  return d.close;
};
var bisectDate = bisector(function (d) {
  return new Date(d.date);
}).left;
exports.default = withTooltip(function (_a) {
  var width = _a.width,
    height = _a.height,
    _b = _a.margin,
    margin = _b === void 0 ? { top: 0, right: 0, bottom: 0, left: 0 } : _b,
    showTooltip = _a.showTooltip,
    hideTooltip = _a.hideTooltip,
    tooltipData = _a.tooltipData,
    _c = _a.tooltipTop,
    tooltipTop = _c === void 0 ? 0 : _c,
    _d = _a.tooltipLeft,
    tooltipLeft = _d === void 0 ? 0 : _d;
  if (width < 10) return null;
  // bounds
  var innerWidth = width - margin.left - margin.right;
  var innerHeight = height - margin.top - margin.bottom;
  // scales
  var dateScale = useMemo(
    function () {
      return scaleTime({
